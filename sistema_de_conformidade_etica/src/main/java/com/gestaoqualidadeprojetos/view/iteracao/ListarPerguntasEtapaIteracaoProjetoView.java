 ...
 * @author Gabriel
 */
public class ListarPerguntasEtapaIteracaoProjetoView extends javax.swing.JFrame {

    /**
     * Creates new form ListarProjetosView
     */
    public ListarPerguntasEtapaIteracaoProjetoView() {
        initComponents();
        setVisible(true);
        setResizable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ListarPerguntasEtapaIteracaoProjetoView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListarPerguntasEtapaIteracaoProjetoView().setVisible(true);
            }
        });
    }

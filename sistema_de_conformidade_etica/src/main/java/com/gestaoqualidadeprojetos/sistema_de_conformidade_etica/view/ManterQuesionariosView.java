 ...
 * @author Gabriel
 */
public class ManterQuesionariosView extends javax.swing.JFrame {

    /**
     * Creates new form SelecionarModeloQuestionarioView
     */
    public ManterQuesionariosView() {
        initComponents();
        setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ManterQuesionariosView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ManterQuesionariosView().setVisible(true);
            }
        });
    }
